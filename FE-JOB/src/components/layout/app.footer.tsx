            ...
            <div className={styles["footer-container"]}>
                <div className={styles["footer-col"] + ' ' + styles["logo-col"]}>
                    ...
                    <div className={styles["footer-social"]}>
                        <a href="#" aria-label="LinkedIn" className={styles["footer-social-icon"]}>
                            {/* LinkedIn SVG */}
                        ...
                        <a href="#" aria-label="Facebook" className={styles["footer-social-icon"]}>
                            {/* Facebook SVG */}
                ...
                <div className={styles["footer-col"]}>
                    <div className={styles["footer-title"]}>Về ITviec</div>
                    <ul>
                ...
                <div className={styles["footer-col"] + ' ' + styles["contact-col"]}>
                    ...
                    <ul className={styles["footer-contact-list"]}>
                        <li><span className={styles["footer-contact-icon"]}>📞</span> Hồ Chí Minh: (+84) 977 460 519</li>
                        <li><span className={styles["footer-contact-icon"]}>📞</span> Hà Nội: (+84) 983 131 351</li>
                        <li><span className={styles["footer-contact-icon"]}>✉️</span> Email: <a href="mailto:love@itviec.com">love@itviec.com</a></li>
