...
import { App, Button, Col, ConfigProvider, Divider, Modal, Row, Upload, UploadProps } from "antd";
...
const ApplyModal = (props: IProps) => {
    ...
    const handleOkButton = async () => {
        ...
        if (!isAuthenticated) {
            ...
            //todo
            if (!jobDetail?.id || !user?.email || !user?.id) {
                message.error("Thiếu thông tin ứng tuyển!");
                return;
            }
            if (jobDetail) {
