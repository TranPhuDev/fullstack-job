...
import vn.tranphudev.jobhunter.domain.response.resume.ResCreateResumeDTO;
import vn.tranphudev.jobhunter.domain.response.resume.ResFetchResumeDTO;
import vn.tranphudev.jobhunter.domain.response.resume.ResUpdateResumeDTO;
import vn.tranphudev.jobhunter.service.ResumeService;
...
public class ResumeController {
    ...
    public ResumeController(ResumeService resumeService, FilterBuilder filterBuilder,
